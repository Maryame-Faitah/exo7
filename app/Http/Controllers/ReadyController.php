...
class ReadyController extends Controller
{
    ...
    {
        $readys = Ready::all();
        return view('admin.main.ready.index',compact('readys'));
    }
    ...
    {
        return view('admin.main.ready.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.main.ready.edit',compact('ready'));
    }
