            ...
            <div class="col-md-4 col-sm-5 sidebar">
                ...
                <div class="widget-item">
                    ...
                    @if (count($tags) !== 0)
                        @foreach ($tags as $tag)
                            <ul class="tag">
                                <li><a href="">{{$tag->tag1}}</a></li>
                                <li><a href="">{{$tag->tag2}}</a></li>
                                <li><a href="">{{$tag->tag3}}</a></li>
                                <li><a href="">{{$tag->tag4}}</a></li>
                                <li><a href="">{{$tag->tag5}}</a></li>
                                <li><a href="">{{$tag->tag6}}</a></li>
                                <li><a href="">{{$tag->tag7}}</a></li>
                                <li><a href="">{{$tag->tag8}}</a></li>
                            </ul>        
                        @endforeach
                    @else
                        <ul class="tag">
